 ...
 */
final class Version20231001002734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pessoas CHANGE cpf cpf VARCHAR(14) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pessoas CHANGE cpf cpf VARCHAR(15) NOT NULL');
    }
}
